...
const clsx = (...classNames) => classNames.join("  ")
...
export const CardHeaderTitle = forwardRef(({ className, children, ...props }, ref) => (
  // eslint-disable-next-line jsx-a11y/heading-has-content
  <h3 {...props} ref={ref} className={clsx("card-label", className)}>{ children }</h3>
));
